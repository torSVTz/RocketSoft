...
?>
<section class="theme-block theme-testimonial <?php if($activate_theme == 'Business Street' || $activate_theme == 'InteriorPress') { echo 'vrsn-two theme-bg-default'; } ?>" id="theme-testimonial">

<?php if($activate_theme != 'Business Street') {?>
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					...
					<?php if($arilewp_testimonial_area_title != null): ?>
						<p class="theme-section-subtitle  <?php if($activate_theme == 'Business Street' || $activate_theme == 'StrangerWP' || $activate_theme == 'InteriorPress') { echo 'text-light'; } ?>"><?php echo wp_kses_post($arilewp_testimonial_area_title); ?></p>
					<?php endif; ?>
					<?php if($arilewp_testimonial_area_des != null): ?>
						<h2 class="theme-section-title <?php if($activate_theme == 'Business Street' || $activate_theme == 'StrangerWP' || $activate_theme == 'InteriorPress') { echo 'text-light'; } ?>"><?php echo wp_kses_post($arilewp_testimonial_area_des); ?></h2>
					<?php endif; ?>
						<div class="theme-separator-line-horrizontal-full <?php if($activate_theme == 'Business Street') { echo 'theme-bg-light'; } ?>"></div>
					</div>
				</div>
			</div>
	    <?php endif; ?>
